...
set_property -dict { PACKAGE_PIN "N11"    IOSTANDARD LVCMOS33 } [get_ports { sys_clock }]     ;                # IO_L13P_T2_MRCC_14            Sch = CLK
create_clock -add -name clk_pin -period 10.00 -waveform {0 5}   [get_ports { sys_clock }]     ;
...
#                                               Push Buttons                                                       #
####################################################################################################################
set_property -dict { PACKAGE_PIN "F5"   IOSTANDARD LVCMOS33 } [get_ports { BTN }];                     # IO_L13P_T2_MRCC_35            Sch = SW0
...
#                                               LEDs                                                               #
####################################################################################################################
set_property -dict { PACKAGE_PIN "K12"   IOSTANDARD LVCMOS33    SLEW FAST} [get_ports { LD0 }];                      # IO_0_14                       Sch = LED0
set_property -dict { PACKAGE_PIN "K13"   IOSTANDARD LVCMOS33    SLEW FAST} [get_ports { LD1 }];                      # IO_L5P_T0_D06_14              Sch = LED1
set_property -dict { PACKAGE_PIN "R10"   IOSTANDARD LVCMOS33    SLEW FAST} [get_ports { LD2 }];                      # IO_L17P_T2_A14_D30_14         Sch = LED2
set_property -dict { PACKAGE_PIN "R13"   IOSTANDARD LVCMOS33    SLEW FAST} [get_ports { LD3 }];                      # IO_L16P_T2_CSI_14             Sch = LED3
...
#                                               Header P4                                                         #
###################################################################################################################
set_property -dict  { PACKAGE_PIN "E12"   IOSTANDARD LVCMOS33  } [get_ports {i0b}];                        # IO_L13P_T2_MRCC_15            Sch = GPIO_1_P
set_property -dict  { PACKAGE_PIN "E13"   IOSTANDARD LVCMOS33  } [get_ports {i0a}];                        # IO_L13N_T2_MRCC_15            Sch = GPIO_1_N
set_property -dict  { PACKAGE_PIN "E16"   IOSTANDARD LVCMOS33  } [get_ports {i1b}];                        # IO_L17P_T2_A26_15             Sch = GPIO_2_P
set_property -dict  { PACKAGE_PIN "D16"   IOSTANDARD LVCMOS33  } [get_ports {i1a}];                        # IO_L17N_T2_A25_15             Sch = GPIO_2_N
set_property -dict  { PACKAGE_PIN "F15"   IOSTANDARD LVCMOS33  } [get_ports {i2b}];                        # IO_L18P_T2_A24_15             Sch = GPIO_3_P
set_property -dict  { PACKAGE_PIN "E15"   IOSTANDARD LVCMOS33  } [get_ports {i2a}];                        # IO_L18N_T2_A23_15             Sch = GPIO_3_N
set_property -dict  { PACKAGE_PIN "G14"   IOSTANDARD LVCMOS33  } [get_ports {i3b}];                        # IO_L21P_T3_DQS_15             Sch = GPIO_4_P
set_property -dict  { PACKAGE_PIN "F14"   IOSTANDARD LVCMOS33  } [get_ports {i3a}];                        # IO_L21N_T3_DQS_A18_15         Sch = GPIO_4_N

set_property -dict  { PACKAGE_PIN "L4"    IOSTANDARD LVCMOS33   SLEW FAST } [get_ports {o0}];                       # IO_L1P_T0_34                  Sch = GPIO_18_P
set_property -dict  { PACKAGE_PIN "N1"    IOSTANDARD LVCMOS33   SLEW FAST } [get_ports {o1}];                       # IO_L4P_T0_34                  Sch = GPIO_17_P
set_property -dict  { PACKAGE_PIN "M2"    IOSTANDARD LVCMOS33   SLEW FAST } [get_ports {o2}];                       # IO_L2P_T0_34                  Sch = GPIO_16_P
set_property -dict  { PACKAGE_PIN "N3"    IOSTANDARD LVCMOS33   SLEW FAST } [get_ports {o3}];                       # IO_L3P_T0_DQS_34              Sch = GPIO_15_P
